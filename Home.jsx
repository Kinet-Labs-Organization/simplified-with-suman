                    ...
                    <section id="episodes">
                        ...
                        <div className="episodes-grid">
                            ...
                            <div className="glass-card">
                                ...
                                <Link to="/whats-behind-the-curtain-of-ai-magic" className="play-btn" style={{display:'inline-block', textDecoration:'none'}}><i className="fa-solid fa-play"></i> Read (10:00)</Link>
                            </div>
                            ...
                            <div className="glass-card">
                                ...
                                <Link to="/time-beats-money-in-building-wealth" className="play-btn" style={{display:'inline-block', textDecoration:'none'}}><i className="fa-solid fa-play"></i> Read (10:00)</Link>
                            </div>
                            ...
                            <div className="glass-card">
                                ...
                                <Link to="/are-you-really-financially-safe" className="play-btn" style={{display:'inline-block', textDecoration:'none'}}><i className="fa-solid fa-play"></i> Read (10:00)</Link>
                            </div>
                        </div>
                    </section>
